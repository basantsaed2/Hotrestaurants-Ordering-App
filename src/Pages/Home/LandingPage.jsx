            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-5 items-center justify-center gap-x-3 pt-4 xl:p-6">
                ...
                <div className="w-full flex flex-wrap gap-4 justify-center items-center gap-x-4 md:gap-x-6">
                    ...
                    type.status === 1 && (
                        <span
                        key={type.id}
                        className={`flex min-w-40 h-40 flex-col items-center justify-center gap-2 text-xl font-TextFontRegular px-4 py-2 rounded-lg cursor-pointer border-2 transition-all ease-in-out duration-300 hover:border-mainColor hover:bg-mainColor hover:text-white
