...
const CheckOutPage = () => {
       ...
       const { postData: postOrder, loadingPost: loadingOrder, response: responseOrder } = usePost({ url: 'https://hotrestaurantsbcknd.food2go.online/customer/make_order', type: true });
