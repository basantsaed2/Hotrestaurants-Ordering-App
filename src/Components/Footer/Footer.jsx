...
const Footer = () => {
  return (
    ...
    <div className="w-full max-w-6xl mx-auto px-5">
      ...
      <span className="text-3xl font-semibold">Hot Restaurants</span>
      </div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center space-x-2">
               ...
               <li className="flex items-center space-x-2">
                ...
                <span>Address: 21 ميدان سعد زغلول محطة الرمل ـ الاسكندرية, Alexandria, Egypt</span>
              </li>
          </ul>
          {/* Social Media Links */}
          <div className="flex space-x-4 mt-4">
            <Link
              to="https://www.facebook.com/HotRestaurantsEgypt"
              target="_blank"
            ...
            <Link
              to="https://www.instagram.com/hotrestaurantseg/#"
              target="_blank"
              className="p-3 bg-white text-mainColor rounded-full hover:bg-gray-300 transition duration-300"
            >
      ...
      <Link to="https://food2go.online/" target="_blank" className="flex items-center justify-center gap-2 text-sm mt-2 border-t border-white pt-4">
        ...
        <h1 className="text-white font-semibold text-lg">Hot Restaurants</h1>
        </Link>
    </div>
  </div>
  );
